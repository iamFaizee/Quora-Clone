...
import { Heading,Avatar,HStack,Modal,
  ModalOverlay,
  ModalContent,
  ModalHeader,
  ModalFooter,
              ...
              <div className="sidebox">
                <div className="left">
                  ...
                  >
                    <ModalOverlay />
                    <ModalContent>
                      <ModalHeader>Edit credentials <br/>  <Text fontWeight="light" color="#33363d"  fontSize='md'>Credentials add credibility to your content</Text></ModalHeader>
                      <ModalCloseButton />
                      <ModalBody pb={6}>
                        <div>
                          <h1>{user.name}</h1>
...
<div  className="box2">
  ...
  <TabList mb=".6em">
    ...
    <Tab _selected={{ color: "red", bg: "white" }} _hover={{ bg: "gray.200" }}>Answers</Tab>
