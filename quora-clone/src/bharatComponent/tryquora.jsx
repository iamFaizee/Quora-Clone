import { Box, Button, Center, CloseButton,  Flex, HStack, Image, Input, InputGroup, InputLeftElement, InputRightElement, Modal, ModalContent, ModalOverlay, Radio, RadioGroup, Spacer, Text, VStack, useDisclosure } from '@chakra-ui/react'
...
const Tryquora = () => {
    ...
    return <>
    <Box >
        <Button colorScheme={dark? 'blackAlpha.900':'white'} onClick={onOpen}  borderWidth='2px' px='15px' rounded='50px' bg='white' color='grey' size='sm' maxWidth='90px' minWidth='90px'>
