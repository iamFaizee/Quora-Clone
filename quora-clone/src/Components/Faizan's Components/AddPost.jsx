...
import {  CloseButton,  HStack,  Input, Modal, ModalContent, ModalOverlay, Text, useDisclosure } from '@chakra-ui/react'
...
// import downarrow from 'C:/Users/bhara/OneDrive/Desktop/Quora/Quora-Clone/quora-clone/src/bharatComponent/images/downarrow.svg'
// import rightfillarrow from '../bharat';
...
function AddPost(props) {
    ...
    return (
        <Box border="0.1px solid lightgray" maxW="100%" bg={dark? 'blackAlpha.900':'white'} borderRadius="4px" >
            ...
            <Box display="flex" gap="1rem" p="0.5rem">
                ...
                <Button  bg={dark? 'blackAlpha.900':'rgb(241,242,242)'}
            ...
            <Flex bg={dark? 'blackAlpha.900':'white'} p="0 0.3rem 0.3rem 0.3rem">
                <Button
                leftIcon={<BsQuestionSquare/>}
                borderRadius="2rem"
                size="sm"
                w="100%"
                colorScheme = {dark? 'black':'null'}
                        ...
                        <ModalContent h='420px' p='10px' color='gray'>
                            ...
                            <HStack py='20px' px='10px'>
                                ...
                                <Button boxShadow='inner' borderRadius='50px' bg='white' border='1px solid silver' size='sm'>
                                    ...
                                    <Image color='black' ml={'5px'} w='15px' src='' />
                                </Button>
